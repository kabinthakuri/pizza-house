...
class PizzaController extends Controller
{
    ...
    public function update(PizzaUpdateRequest $request, $id)
    {
        ...
        if($request->has('image')){
            $path=$request->file('image')->store('public/upload/pizza_image');
        }else{
            $path=$pizza->image;
        }
        $pizza->name=$request->name;
        ...
        $pizza->image=$path;
        $pizza->save();
        return redirect()->route('pizza.index')->with('info','Pizza update successfully.');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pizza.index')->with('info','pizza deleted successfully.');
    }
}
